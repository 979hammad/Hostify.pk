...
const Hfacilities = ({ name, data }) => {
  ...
  return (
    <>
      <form className='mainDivFacilites facilitiesUpdateDiv' onSubmit={handleSubmit(submitForm)}>
        {/* <span className="FHeading">Now Select Facilities & Rules</span> */}
        <span className="facilitiesSec extraPadding">Facilities Section</span>
